...
public class HandRepository {
    ...
    private Logger LOG = LoggerFactory.getLogger(HandRepository.class);

    public int[] drawAndEvaluateHand(Deck deck){
        Card[] cards;
        int[] value;
        value = new int[6];
        cards = new Card[5];
        ...
        //execute hand evaluation
        value = evaluateHand(orderedRanks, sameCards, sameCards2, largeGroupRank, smallGroupRank, straight, flush);
    ...
    public String translateHandValue(int[] value)
    {
        String s;
        switch( value[0] )
        {
    ...
    private int[] evaluateHand(int[] orderedRanks, int sameCards, int sameCards2, int largeGroupRank, int smallGroupRank, boolean straight, boolean flush){
        int[] value = new int[6];;
        ...
        {
            value[0]=5;
            value[1]=0; //TODO get proper value https://www.codeproject.com/Articles/38821/Make-a-poker-hand-evalutator-in-Java
        }
        ...
        {
            value[0]=9;
            value[1]=2; //TODO get proper value https://www.codeproject.com/Articles/38821/Make-a-poker-hand-evalutator-in-Java
        }
